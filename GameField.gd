...
@onready var dustcloudParticles1 : GPUParticles2D = $CenterPosition/DustCloud1
@onready var dustcloudParticles2 : GPUParticles2D = $CenterPosition/DustCloud2
@onready var puff1 : GPUParticles2D = $CenterPosition/Puff1
@onready var puff2 : GPUParticles2D = $CenterPosition/Puff2
